...
void getResult(vector<int> &data,int left,int right,int &result)
{
    if(left>=right)
        return;
    int mid=left+(right-left)/2;
    getResult(data, left, mid, result);
    getResult(data, mid+1, right, result);
